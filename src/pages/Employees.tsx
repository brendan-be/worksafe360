...
import { Search, Filter, UserPlus, Mail, Phone, MapPin, ChevronRight } from 'lucide-react'
        ...
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 40, maxWidth: 1400 }}>
                ...
                <div className="animate-in" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button className="btn btn-amber" onClick={() => setShowAdd(true)}><UserPlus style={{ width: 16, height: 16 }} />Add Staff Member</button>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
                    {filtered.map((emp, i) => (
                        <div
                            ...
                            style={{
                                padding: 32, cursor: 'pointer', animationDelay: `${i * 50}ms`,
                                transition: 'transform 0.2s, box-shadow 0.2s',
                            }}
                            onMouseEnter={e => {
                                (e.currentTarget as HTMLDivElement).style.transform = 'translateY(-2px)'
                                    ; (e.currentTarget as HTMLDivElement).style.boxShadow = '0 8px 24px -4px rgba(15,23,42,0.1)'
                            }}
                            onMouseLeave={e => {
