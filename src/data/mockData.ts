...
export interface ImprovementNote {
  ...
  category: 'safety' | 'health' | 'infrastructure' | 'process';
  description: string; site: string;
  routedTo: string[]; status: 'submitted' | 'acknowledged' | 'actioned';
}
...
export interface Recognition {
  id: string; from: string; to: string; type: 'values' | 'behavioural' | 'shout-out' | 'high-performance';
  value?: string; message: string; date: string; visibility: 'company' | 'site' | 'team' | 'private';
}
